...
# main parameters
main_pars = {
    'outPath': './CLEESE_output_data_voxceleb_pitch_stretch/',   # output root folder
    'numFiles': 5,     # number of output files to generate (for random modifications)
    'chain': True,      # apply transformation in series (True) or parallel (False)
    'transf': ['stretch'],   # transformations to apply
    # 'transf': ['stretch','pitch','eq','gain'],   # chain example
...
pitch_pars = {
    ...
    'numWin': 0,       # number of pitch transposition windows. If 0 : static transformation
